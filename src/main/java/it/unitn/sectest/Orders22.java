...
public class Orders22 extends BaseTest {
	
	@Test
	public void orders22Test() {
		 ...
		 * 3. Add Brand
		 * 4. Add Product 
		 * 5. Add Order with XSS attack in client contact, closing the already opened input tag
		...
		addOrder("01/15/2020", "ClientNameTest", "\"><h1>ClientContactTest</h1>","TestProduct", "1", "1", "1", "Cash", "No Payment", "In Gujarat");
		...
		try {
			attack = driver.findElement(By.xpath("//h1[contains(., 'ClientContactTest')]"));
		}  catch (Exception Ex) {
